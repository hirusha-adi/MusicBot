    ...
    async def help(self, ctx, subtype="all"):
        ...
        try:
            ...
            if subtype in connect_wl:
                ...
                embed.add_field(
                    name="Description", value=f"Connect the player to a voice channel", inline=False)
                embed.add_field(
                    name="Aliases", value="con,\nc,\nconnect ", inline=False)
                ...
                embed.set_author(
                    name=f"{config.BotInfo.BOT_NAME}", icon_url=f"{config.BotInfo.BOT_AVATAR_URL}")
                embed.add_field(
                    name="Description", value=f"Disconnect the player to a voice channel", inline=False)
                embed.add_field(
                    name="Aliases", value="dc, \ndisconnect", inline=False)
                embed.set_footer(text=f"Requested by {ctx.author.name}")
                await ctx.send(embed=embed)
                ...
                embed.set_author(
                    name=f"{config.BotInfo.BOT_NAME}", icon_url=f"{config.BotInfo.BOT_AVATAR_URL}")
                embed.add_field(
                    name="Description", value=f"Play or add song to queue", inline=False)
                embed.add_field(
                    name="Aliases", value="p, \nplay", inline=False)
                embed.set_footer(text=f"Requested by {ctx.author.name}")
                await ctx.send(embed=embed)
                ...
                embed.set_author(
                    name=f"{config.BotInfo.BOT_NAME}", icon_url=f"{config.BotInfo.BOT_AVATAR_URL}")
                embed.add_field(
                    name="Description", value=f"Skip currently playing song", inline=False)
                ...
                embed.add_field(name="Description",
                                value=f"Pause the current song", inline=False)
                ...
                embed.set_author(
                    name=f"{config.BotInfo.BOT_NAME}", icon_url=f"{config.BotInfo.BOT_AVATAR_URL}")
                embed.add_field(
                    name="Description", value=f"Resume the current paused song", inline=False)
                ...
                embed.set_author(
                    name=f"{config.BotInfo.BOT_NAME}", icon_url=f"{config.BotInfo.BOT_AVATAR_URL}")
                embed.add_field(
                    name="Description", value=f"Seek the music backward or forward", inline=False)
                ...
                embed.set_author(
                    name=f"{config.BotInfo.BOT_NAME}", icon_url=f"{config.BotInfo.BOT_AVATAR_URL}")
                embed.add_field(name="Description",
                                value=f"Set volume for the music", inline=False)
                embed.add_field(
                    name="Aliases", value="volume, \nvol", inline=False)
                embed.set_footer(text=f"Requested by {ctx.author.name}")
                await ctx.send(embed=embed)
                ...
                embed.set_author(
                    name=f"{config.BotInfo.BOT_NAME}", icon_url=f"{config.BotInfo.BOT_AVATAR_URL}")
                embed.add_field(
                    name="Description", value=f"Set loop to `NONE`, `CURRENT` or `PLAYLIST`", inline=False)
                ...
                embed.set_author(
                    name=f"{config.BotInfo.BOT_NAME}", icon_url=f"{config.BotInfo.BOT_AVATAR_URL}")
                embed.add_field(name="Description",
                                value=f"What's playing now?", inline=False)
                embed.add_field(
                    name="Aliases", value="nowplaying \nnp", inline=False)
                embed.set_footer(text=f"Requested by {ctx.author.name}")
                await ctx.send(embed=embed)
                ...
                embed.set_author(
                    name=f"{config.BotInfo.BOT_NAME}", icon_url=f"{config.BotInfo.BOT_AVATAR_URL}")
                embed.add_field(name="Description",
                                value=f"Bot's current queue", inline=False)
                embed.add_field(
                    name="Aliases", value="queue \nq", inline=False)
                embed.set_footer(text=f"Requested by {ctx.author.name}")
                await ctx.send(embed=embed)
                ...
                embed.set_author(
                    name=f"{config.BotInfo.BOT_NAME}", icon_url=f"{config.BotInfo.BOT_AVATAR_URL}")
                embed.add_field(name="Description",
                                value=f"Set equalizer", inline=False)
                embed.add_field(
                    name="Aliases", value="equalizer \neq", inline=False)
                embed.set_footer(text=f"Requested by {ctx.author.name}")
                await ctx.send(embed=embed)
